    ...
    if (!this.options.dev && moduleOptions.publicPath) {
        ...
        this.nuxt.hook('generate:done', () => {
            ...
            if (moduleOptions.dotEnvExport &&
                ...
                const envOutput = `${os_1.EOL}# Added by 'nuxt-laravel' module${os_1.EOL}${nuxtOutputEnv}=${path_1.default.join(destDir, fileName)}`;
                fs_extra_1.default.writeFileSync(envPath, envInput.includes(nuxtOutputEnv)
